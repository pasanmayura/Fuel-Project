...
import { Home, CircleUser, Users, Fuel, FileChartColumn, ArrowLeftRight, LogOut, ChevronRight, Menu, X } from 'lucide-react';
...
const menuItems = [
  ...
  { id: 'employee', name: 'Employee', icon: Users, href: '/employee' },
  { id: 'station', name: 'Fuel Station', icon: Fuel, href: '/station' },
  { id: 'transaction', name: 'Fuel Transactions', icon: ArrowLeftRight, href: '/transaction' },
  { id: 'report', name: 'Reports', icon: FileChartColumn, href: '/report' },
  { id: 'myaccount', name: 'My Account', icon: CircleUser, href: '/myaccount' },
];
  ...
  return (
    <>
      ...
      <div className={`
        ...
        lg:z-auto
      `}>
        <div className="relative bg-gradient-to-r from-blue-600 via-blue-700 to-blue-700 shadow-xl">
