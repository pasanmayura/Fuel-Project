...
import { getUserDetails } from '@/service/dashboardMainService';
...
export default function Topbar() {
  ...
  return (
    <div className="bg-white border-b border-blue-500 shadow-sm px-10 py-6 flex justify-end items-center">     
